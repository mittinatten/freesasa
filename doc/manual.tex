...
%This document is organized as follows. Section \ref{sec:cli} describes
%how to use the CLI and section \ref{sec:api} gives a short sample
%program demonstrating basic use of the API. This introduction is
%intended to cover most casual users' needs. The appendix describes the
%algorithms, a few implementation details and has a performance
%analysis of the program. A full Doxygen-generated documentation of
%the API is available at \url{http://mittinatten.github.io/freesasa/},
%and is also included in the source files.

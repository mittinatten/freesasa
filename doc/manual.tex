...
\begin{pspicture}(0,6)
  % ellipses
  \psellipse[linestyle=dashed,linewidth=0.01,linecolor=gray](3,3)(2,0.5)
  \psellipse[linestyle=dashed,linewidth=0.01,linecolor=gray](3,4)(1.7321,0.4330)
  \psellipse[linestyle=dashed,linewidth=0.01,linecolor=gray](3,2)(1.7321,0.4330)
  % other slices
  %\psline[linecolor=gray,linewidth=0.01](0,5)(6,5)
  %\psline[linecolor=gray,linewidth=0.01](0,3)(6,3)
  %\psline[linecolor=gray,linewidth=0.01](0,2)(6,2)
  %\psline[linecolor=gray,linewidth=0.01](0,1)(6,1)
  \pscircle(3,3){2}
  % the slice
  %\psline(0,4)(6,4)
  \psline(-1,2.9)(1,5.1)(7,5.1)(5,2.9)(-1,2.9)
  % triangle
  \psline[linearc=0.001](3,3)(3,4)(1.2679,4)(3,3)
  % coordinates and lengths
  \psdot[dotscale=0.75](3,3)
  \put(2.8,2.6){$(x_i,y_i,z_i)$}
  \psdot[dotscale=0.75](3,4)
  \put(2.8,4.15){$(x_i,y_i,z)$}
  \put(1.9,3.1){$R_i$}
  \put(2.1,4.2){$R_i^\prime$}
  \put(3.1,3.4){$\lvert z-z_i\rvert$}

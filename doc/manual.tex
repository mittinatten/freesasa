...
available to academic users). The program DSSP calculates accessible
...
FreeSASA is both a standalone command line program and a C library
...
auto-generated scripts needed to build and install the program.

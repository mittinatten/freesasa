...
demonstrating basic use of the API. This introduction is intended to
cover most casual users' needs.  Appendix \ref{sec:algorithm}
describes the algorithms and some implementation details. Appendix
\ref{sec:performance} gives a performance analysis of the program.  A
full Doxygen-generated documentation of the API is available at
...
calculations (in som cases 10's of milliseconds), each calculation was
run three times.
